...
describe('findDivisors', () => {
  ...
  it('should return "13 is prime" when given 13', () => {
    expect(findDivisors(13)).toStrictEqual("13 is prime");
  });

  it('should return "3 is prime" when given 3', () => {
    expect(findDivisors(3)).toStrictEqual("3 is prime");
  });
